...
class ProductsManagerTestCase(TestCase):
    def setUp(self):
        self.product1 = Product.objects.create(Product_name="Test Product 1", Product_description="Description 1", Product_stars=4, Product_available_quantity=10, Product_single_price=19.99)
        self.product2 = Product.objects.create(Product_name="Test Product 2", Product_description="Description 2", Product_stars=3, Product_available_quantity=5, Product_single_price=29.99)
        self.product3 = Product.objects.create(Product_name="Test Product 3", Product_description="Description 3", Product_stars=5, Product_available_quantity=20, Product_single_price=9.99)
        self.client = Client()
    ...
    def test_add_product(self):
        response = ProductsManager.AddProduct("New Product", "New Description", None, None, 4, 15, None, 24.99)
